...
#ifndef APPLICATIONS_INC_MPU9250_H_
#define APPLICATIONS_INC_MPU9250_H_
...
#define MPU9250_SLV_ENABLE				0x80
#define MPU9250_SLV4_TRANS_DONE			0x40
...
#define MPU9250_AK8963_READ_FLAG      			0x80
#define MPU9250_AK8963_WRITE_FLAG 				0x00
...
void mpu_get_9axis(double* ax_, double* ay_, double* az_, double* gx_, double* gy_, double* gz_,double* mx_, double* my, double* mz);
...
#endif /* APPLICATIONS_INC_MPU9250_H_ */
